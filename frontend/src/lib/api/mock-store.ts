...
export const requirements: TenderRequirement[] = [
  { id: "REQ-1", tenderId: "TND-1001", requirement: "Valid PAN of the bidding entity", mandatory: true },
  { id: "REQ-2", tenderId: "TND-1001", requirement: "Active GST registration in the state of supply", mandatory: true },
  {
    id: "REQ-3",
    tenderId: "TND-1001",
  ...
  { id: "REQ-5", tenderId: "TND-1001", requirement: "NSIC single point registration certificate", mandatory: false },
  { id: "REQ-6", tenderId: "TND-1002", requirement: "Valid PAN of the bidding entity", mandatory: true },
  { id: "REQ-7", tenderId: "TND-1002", requirement: "Active GST registration", mandatory: true },
  { id: "REQ-8", tenderId: "TND-1002", requirement: "Active ESIC registration code", mandatory: true },
  { id: "REQ-9", tenderId: "TND-1003", requirement: "Valid PAN of the bidding entity", mandatory: true },
...
export const documents: TenderDocument[] = [
  { id: "DOC-9001", tenderBidId: "BID-3001", documentType: "PAN", fileName: "pan-aarav-infratech.pdf", status: "VERIFIED", uploadedAt: iso(-7) },
  { id: "DOC-9002", tenderBidId: "BID-3001", documentType: "GST", fileName: "gst-certificate.pdf", status: "VERIFIED", uploadedAt: iso(-7) },
  { id: "DOC-9003", tenderBidId: "BID-3001", documentType: "UDYAM", fileName: "udyam-registration.pdf", status: "VERIFIED", uploadedAt: iso(-7) },
  { id: "DOC-9004", tenderBidId: "BID-3001", documentType: "EPFO", fileName: "epfo-establishment.jpg", status: "PROCESSED", uploadedAt: iso(-6) },
  { id: "DOC-9005", tenderBidId: "BID-3001", documentType: "NSIC", fileName: "nsic-certificate.pdf", status: "VERIFIED", uploadedAt: iso(-6) },
  { id: "DOC-9006", tenderBidId: "BID-3002", documentType: "PAN", fileName: "pan-aarav-infratech.pdf", status: "VERIFIED", uploadedAt: iso(-2) },
  { id: "DOC-9007", tenderBidId: "BID-3002", documentType: "ESIC", fileName: "esic-code.pdf", status: "FAILED", uploadedAt: iso(-2) },
  { id: "DOC-9101", tenderBidId: "BID-3004", documentType: "PAN", fileName: "meridian-pan.pdf", status: "VERIFIED", uploadedAt: iso(-4) },
  { id: "DOC-9102", tenderBidId: "BID-3004", documentType: "GST", fileName: "meridian-gst.pdf", status: "VERIFIED", uploadedAt: iso(-4) },
  { id: "DOC-9103", tenderBidId: "BID-3005", documentType: "GST", fileName: "northline-gst.jpg", status: "PROCESSED", uploadedAt: iso(-6) },
  { id: "DOC-9104", tenderBidId: "BID-3006", documentType: "PAN", fileName: "meridian-pan.pdf", status: "VERIFIED", uploadedAt: iso(-2) },
];
...
export const intelligence: Record<string, DocumentIntelligence> = {
  "DOC-9001": {
    documentId: "DOC-9001",
    ocr: { documentNumber: "AACCA4821K", holderName: "Aarav Infratech Solutions Pvt Ltd", confidence: 0.97, quality: "GOOD" },
    verification: verification("PAN", "VERIFIED", "Income Tax Department"),
  },
  "DOC-9002": {
    documentId: "DOC-9002",
    ocr: { documentNumber: "27AACCA4821K1ZP", holderName: "Aarav Infratech Solutions Pvt Ltd", issuedOn: iso(-900), confidence: 0.94, quality: "GOOD" },
    verification: verification("GST", "VERIFIED", "GSTN Public API"),
  },
  "DOC-9003": {
    documentId: "DOC-9003",
    ocr: { documentNumber: "UDYAM-MH-26-0044817", holderName: "Aarav Infratech Solutions Pvt Ltd", issuedOn: iso(-700), confidence: 0.91, quality: "GOOD" },
    verification: verification("UDYAM", "VERIFIED", "Udyam Registration Portal"),
  },
  "DOC-9004": {
    documentId: "DOC-9004",
    ocr: { documentNumber: "MHPUN0043912000", holderName: "Aarav Infratech Solutions", confidence: 0.63, quality: "LOW_CONFIDENCE" },
  ...
  "DOC-9005": {
    documentId: "DOC-9005",
    ocr: { documentNumber: "NSIC/SPRC/PUN/2291", holderName: "Aarav Infratech Solutions Pvt Ltd", validTill: iso(240), confidence: 0.93, quality: "GOOD" },
    verification: verification("NSIC", "VERIFIED", "NSIC Single Point Registration"),
  },
  "DOC-9006": {
    documentId: "DOC-9006",
    ocr: { documentNumber: "AACCA4821K", holderName: "Aarav Infratech Solutions Pvt Ltd", confidence: 0.96, quality: "GOOD" },
    verification: verification("PAN", "VERIFIED", "Income Tax Department"),
  },
  "DOC-9007": {
    documentId: "DOC-9007",
    ocr: { documentNumber: "31000456780001099", holderName: "Aarav Infratech Solutions Pvt Ltd", confidence: 0.88, quality: "GOOD" },
  ...
  "DOC-9101": {
    documentId: "DOC-9101",
    ocr: { documentNumber: "AAGFM9921L", holderName: "Meridian Labworks LLP", confidence: 0.96, quality: "GOOD" },
    verification: verification("PAN", "VERIFIED", "Income Tax Department"),
  },
  "DOC-9102": {
    documentId: "DOC-9102",
    ocr: { documentNumber: "36AAGFM9921L1Z4", holderName: "Meridian Labworks LLP", confidence: 0.95, quality: "GOOD" },
    verification: verification("GST", "VERIFIED", "GSTN Public API"),
  },
  "DOC-9103": {
    documentId: "DOC-9103",
    ocr: { documentNumber: "09AAEFN1187Q1ZR", holderName: "Northline Systems & Networks", confidence: 0.58, quality: "BLURRY" },
