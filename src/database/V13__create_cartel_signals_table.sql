...
-- Stores collusion risk clusters detected by Member 2's AI Collusion Radar service.
-- One row per detected cluster per tender, containing cluster_id, tender_id, bidder_ids,
-- connection_strength, shared_signals, pattern_flags, explanation, recommendation.

CREATE TABLE cartel_signals (
    id                  UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    cluster_id          VARCHAR(100)  NOT NULL,
    tender_id           UUID          NOT NULL,
    bidder_ids          JSONB         NOT NULL,
